                            ...
                            <div class="col-12 col-md-6 col-lg-4" style="min-width: 500px;">
                                <div class="card bg-white mb-5 mt-5 border-0 shadow">
                                    <div class="card-body p-5 text-center">
                                        <div class="h3">Verificar</div>
                                        <p>Seu código foi enviado para você por e-mail</p>
                                        ...
                                        <p class="resend text-muted mb-0">
                                            ...
                                            <a id="resendOtpVerification" href="#">Solicitar
                                                novamente</a>
                                        </p>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    inputs[0].addEventListener("paste", function(event) {
        ...
        for (let i = 0; i < otpLength; i++) {
            if (i < pastedValue.length) {
                ...
                inputs[i].value = ""; // Limpar quaisquer entradas restantes
                inputs[i].focus;
            }
        }
    });
    ...
    $(document).ready(function() {
        $('#verificationForm').submit(function(e) {
            ...
            // concatenar todos os valores de entrada no campo OTP e adicioná-los aos dados do formulário
            var otp = '';
        ...
        $('#resendOtpVerification').click(function() {
            ...
            $.ajax({
                ...
                success: function(res) {
                    $('#resendOtpVerification').text('Reenviar OTP de Verificação');
                    if (res.success) {
                        timer();
