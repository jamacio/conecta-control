                ...
                <div class="card shadow border-0">
                    ...
                    <div class="descript_wrap white-bg">
                        ...
                        <div class="pt-3 text-end">
                            ...
                            @endauth
                            @guest
                            <a href="{{ route('account.login.index') }}" class="btn btn-primary">Faça login para salvar</a>
                            <a href="{{ route('account.login.index') }}" class="btn btn-primary">Faça login para se candidatar</a>
                            @endguest
                        </div>
                    </div>
                </div>
