...
<body>
    <div class="container">
        <div class="card">
            <div class="card-header h2 text-center">Control Email Verification</div>
            <div class="card-body">
                ...
                <div class="card-text">The <span class="fw-bold">Control</span> Team</div>
            </div>
            <div class="card-footer text-muted">
                <!-- copyright text -->
                <div class="text-center">Copyright &copy; 2024 <span class="fw-bold">Control</span></div>
            </div>
        </div>
    </div>
</body>
